...
INSERT INTO Manga (nome, nomeImagem, paginas, preco, sinopse, anoPublicacao, estoque, color, generoManga, autorManga_id) VALUES ('Manga 1', "aaaa", 2000, 200, 19.99, 'Sinopse do Manga 1', 50, "CO", 1, 1);
INSERT INTO Manga (nome, nomeImagem, paginas, preco, sinopse, anoPublicacao, estoque, color, generoManga, autorManga_id) VALUES ('Manga 2', "aaaa", 2005, 250, 24.99, 'Sinopse do Manga 2', 30, "CO", 2, 2);

INSERT INTO Novel (nome, nomeImagem, paginas, preco, sinopse, anoPublicacao, estoque, genero, capitulos, escritorNovel_id) VALUES ('Novel 1', "aaaa", 1995, 300, 29.99, 'Sinopse do Novel 1', 20, '1', 20, 1);
INSERT INTO Novel (nome, nomeImagem, paginas, preco, sinopse, anoPublicacao, estoque, genero, capitulos, escritorNovel_id) VALUES ('Novel 2', "aaaa", 2000, 350, 34.99, 'Sinopse do Novel 2', 15, '4', 30, 2);
